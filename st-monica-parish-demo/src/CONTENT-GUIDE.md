# Content authoring guide — St. Monica's Parish demo site
...
<div class="wp-block-group alignfull quote-band"><blockquote class="wp-block-quote"><p>“…”</p><cite>St. Monica</cite></blockquote></div>
...
* **St. Monica's Parish**, 44 Broadway Avenue, Toronto, ON M4P 1T4. A parish of the Archdiocese of Toronto.
...
* Alt text describes the photo (not the page). Never overclaim what a photo shows; write alt text like "Parishioners praying the rosary" rather than naming people or a setting that is not visible.
